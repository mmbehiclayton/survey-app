...
Route::get('/send-test-email', function () {
    $survey = Survey::first(); // Ensure you have a survey in the database for this test

    Mail::to(['mmbehiclayton@gmail.com', 'info@diasporasupport.co.ke'])->send(new SurveySubmitted($survey));
